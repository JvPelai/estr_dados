...
private:
  ...
  void rotateLeft(NodeType *&tree) const;
  void rotateRight(NodeType *&tree) const;
  void rotateLeftAndRight(NodeType *&tree) const;
  void rotateRightAndLeft(NodeType *&tree) const;
